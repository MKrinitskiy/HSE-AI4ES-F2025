...
- не менее **двух моделей классического машинного обучения** (например, Linear Regression, Random Forest, Gradient Boosting, KNN и др.);
...
- доверительные интервалы для разных моделей (barplot / errorbars);
- прогноз по лучшей модели с наложением истинных значений.
